...
class PointHeadTemplate(nn.Module):
    ...
    def assign_stack_targets_mm(self, points, gt_boxes, extend_gt_boxes=None,
                             ret_box_labels=False, ret_part_labels=False,
                             set_ignore_flag=True, use_ball_constraint=False, central_radius=2.0):
        """
        Args:
        ...
        targets_dict = {
            'point_mm_cls_labels': point_cls_labels,
            'point_mm_box_labels': point_box_labels,
            'point_mm_part_labels': point_part_labels
        }
        return targets_dict
