...
class MMProposalTargetLayer(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        targets_dict = {'mm_rois': batch_rois, 'mm_gt_of_rois': batch_gt_of_rois, 'mm_gt_iou_of_rois': batch_roi_ious,
                        'mm_roi_scores': batch_roi_scores, 'mm_roi_labels': batch_roi_labels,
                        'mm_reg_valid_mask': reg_valid_mask,
                        'mm_rcnn_cls_labels': batch_cls_labels}
    ...
    def sample_rois_for_rcnn(self, batch_dict):
        ...
        rois = batch_dict['mm_rois']
        roi_scores = batch_dict['mm_roi_scores']
        roi_labels = batch_dict['mm_roi_labels']
